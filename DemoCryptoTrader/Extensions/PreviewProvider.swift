...
class DeveloperPreview {
    ...
    let stat1 = StatisticsModel(title: "Market Cap", value: "$25.4Bn", percentageChange: 0.12)
    let stat2 = StatisticsModel(title: "Total Volumne", value: "$1.23Tr")
    let stat3 = StatisticsModel(title: "Portfolio Value", value: "$400.12k", percentageChange: -1.41)
